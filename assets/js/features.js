    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">PEC</span> <span class="clr-green">Canteen</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">PEC</span> <span class="clr-green md">Canteen</span></div>
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <p>Panimalar Engineering College is a postsecondary educational institution located in Chennai, Tamil Nadu, India focusing on engineering.</p>
                        <ul class="py-1">
                            <li><i class="fab fa-facebook-f"></i><a href="https://www.facebook.com/panimalar/" target="_blank"> Facebook</a></li>
                            <li><i class="fab fa-instagram"></i><a href="https://www.instagram.com/panimalar/" target="_blank">Instagram</a></li>
                        </ul>
                    </article>
                    <!-- Navigation Links -->
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="our-vision.html">Our Vision</a></li>
                            <li><a href="https://github.com/rvutd/pec-canteen-site" target="_blank">Git Repository</a></li>
                            <li><a href="https://pecindore.co.in/" target="_blank">PEC Indore</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-phone-alt"></i> <p>090438 90983</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>info@panimalar.ac.in</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Bangalore Trunk Road, Varadharajapuram, Poonamallee, Chennai – 600 123.</p></li>
                        </ul>
                    </article>
                </main>
                <!-- Jaishu Thanu Info -->
                <main class="jaishu-thanuflex">
                    <div class="">Designed & Developed with <i class="fas fa-heart clr-red"></i> By <a href="#">Jaishu Thanu</a></div>
                </main>
            </section>
        `;
        })
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="contact">
                        <ul>
                            <h1 class="sm">Contact Information</h1>
                            <li> <i class="fas fa-phone-alt"></i> <p>+91-90438 91272</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>info@panimalar.ac.in</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>Bangalore Trunk Road, Varadharajapuram, Poonamallee, Chennai – 600 123.</p></li>
                        </ul>
                    </article>
